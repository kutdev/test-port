...
function footer(){
  ...
  if (goder == 10 ) {
    money += 200000000000000;
    money_text.innerHTML = "Geld:" + "€"+ money ;
    tirsayisi += 10000000;
    arabasayisi += 100000000000;
    bakirsayisi += 100000000000;
    titansayisi += 100000000000;
    gemisayisi += 100000000000;
    goder = 0;
    return goder;
  }
  if (goder < 10) {
...
function randomName(){
  var names = ["Albert","Johan","Carl","Klaus","Leo","Zelda","Verena","Ulrica","Suzanne","Delia","Heidi","Johanna","Nikola","Hans","Nadja","Delmira","Diederich","Gunther","Nikolaus","Oskar","Fynn","Tobias","Ben","Hannah","Felix","Noah","Lenny","Daniel","Lisa","Liam","Jonas","Henry","Theo","Jakob","Anton","Malia","Tilda","Elena","Victoria","Mara","Isabella"];
...
function randomProduct(){
  var productl = ["Auto","Baumwollsocken","Sonnenbrille","Reifen","Lederschuhe","Lederhandschuh","Pullover aus Baumwolle","Baumwolljacke","Lederjacke","Lastwagen","Boot"];
...
function sell1(){
  ...
  if (product1 == "Lastwagen" && tirsayisi >= 1) {
    tirsayisi -= 1;
    money += 4500;
    money_text.innerHTML = "Geld:" + "€"+ money;
    document.getElementById("customer1").style.visibility = "hidden";
    return money, tirsayisi;
  }
  if (product1 == "Boot" && gemisayisi >= 1) {
    gemisayisi -= 1;
    money += 18000;
    money_text.innerHTML = "Geld:" + "€"+ money;
    document.getElementById("customer1").style.visibility = "hidden";
    return money, gemisayisi;
  }
  else{
    Swal.fire(
      'Achtung!',
...
function sell2(){
  ...
  if (product2 == "Lastwagen" && tirsayisi >= 1) {
    tirsayisi -= 1;
    money += 4500;
    money_text.innerHTML = "Geld:" + "€"+ money;
    document.getElementById("customer2").style.visibility = "hidden";
  ...
  function items(){
    ...
    if (press_items == 1) {
      ...
      if (metalsayisi >= 1) {
        document.getElementById("metali").style.visibility = "hidden";
      ...
      if (titansayisi >= 1) {
        document.getElementById("titani").style.visibility = "hidden";
        
      }
      if (bakirsayisi >= 1) {
        document.getElementById("bakiri").style.visibility = "hidden";
    ...
    if (press_items == 0) {
      ...
      if (metalsayisi >= 1) {
        document.getElementById("metali").innerHTML = "Metall(Metal) X"+metalsayisi;
        document.getElementById("metali").style.visibility = "visible";
      }
      if (pressalindi == 1) {
        document.getElementById("pressi").style.visibility = "visible";
      }
      if (titansayisi >= 1) {
        document.getElementById("titani").innerHTML = "Titan(Titanyum) X"+titansayisi;
        document.getElementById("titani").style.visibility = "visible";
      }
      if (bakirsayisi >= 1) {
        document.getElementById("bakiri").innerHTML = "Kupfer(Bakır) X"+bakirsayisi;
        document.getElementById("bakiri").style.visibility = "visible";
      }
  ...
  function storage(){
    ...
    if (press_stor == 1) {
      ...
      if (tirsayisi >= 1) {
        document.getElementById("tirl").style.visibility = "hidden";
      }
      if (pcamsayisi >= 1) {
        document.getElementById("pcaml").style.visibility = "hidden";
      }
      if (gemisayisi >= 1) {
        document.getElementById("gemil").style.visibility = "hidden";
      }
    ...
    if (press_stor == 0) {
      ...
      if (tirsayisi >= 1) {
        document.getElementById("tirl").innerHTML = "Lastwagen(Tır) X"+tirsayisi;
        document.getElementById("tirl").style.visibility = "visible";
      }
      if (pcamsayisi >= 1) {
        document.getElementById("pcaml").innerHTML = "Plexiglas(Plastik Cam) X"+pcamsayisi;
        document.getElementById("pcaml").style.visibility = "visible";
      }
      if (gemisayisi >= 1) {
        document.getElementById("gemil").innerHTML = "Boot(Gemi) X"+gemisayisi;
        document.getElementById("gemil").style.visibility = "visible";
      }
...
function crafttir(){
  if (metalsayisi >= 1 && plastisayisi >= 4 && vidasayisi >= 4 && camsayisi >= 2 && derisayisi >= 4 && lastiksayisi >= 2 && makinealindi == 1 && pressalindi == 1) {
    plastisayisi -= 4;
    vidasayisi -= 4;
    camsayisi -= 2;
    derisayisi -= 4;
    ...
    return metalsayisi,derisayisi,camsayisi,tirsayisi,lastiksayisi,plastisayisi,vidasayisi;
...
function craftgemi(){
  if (pcamsayisi >= 10 && titansayisi >= 5 && bakirsayisi >= 1 && derisayisi >= 10 && makinealindi == 1 && pressalindi == 1 && lastiksayisi >= 10) {
    pcamsayisi -= 10;
    titansayisi -= 5;
    bakirsayisi -= 1;
    derisayisi -= 10;
    ...
    return pcamsayisi,derisayisi,titansayisi,gemisayisi,lastiksayisi,bakirsayisi;
...
function craftpcam(){
  if (plastisayisi >= 1 && camsayisi >= 1 && pressalindi == 1 ) {
    camsayisi -= 1;
    plastisayisi -= 1;
    pcamsayisi += 1;
    ...
    return pcamsayisi,plastisayisi,camsayisi;
