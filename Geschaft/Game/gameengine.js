...
function randomName(){
  var names = ["Albert","Johan","Carl","Klaus","Leo","Zelda","Verena","Ulrica","Suzanne","Delia","Heidi","Johanna","Nikola","Hans","Nadja","Delmira","Diederich","Gunther","Nikolaus","Oskar","Fynn","Tobias","Ben","Hannah","Felix","Noah","Lenny","Daniel","Lisa"];
...
function randomProduct(){
  var productl = ["Auto","Baumwollsocken","Sonnenbrille","Reifen","Lederschuhe","Lederhandschuh","Pullover aus Baumwolle","Baumwolljacke","Lederjacke","Lastwagen"];
...
function crafttir(){
  if (metalsayisi >= 1 && plastisayisi >= 4 && vidasayisi >= 4 && camsayisi >= 2 && derisayisi >= 4 && lastiksayisi >= 2 && makinealindi == 1 && pressalindi == 1) {
    ...
    return metalsayisi,derisayisi,camsayisi,arabasayisi,lastiksayisi,plastisayisi,vidasayisi;
